class CapgPrg2
{
	...
	{
			System.out.println("1st letter C & 2nd letter M with lowercase:-"+lowerCaseString("My Company Name is Capgemini"));
			int digitresult=sumOfDigit("12");
			if(digitresult!=0)
			System.out.println("Sum of Digit:-"+digitresult);	
			else
