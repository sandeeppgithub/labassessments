...
public class Emp {
	public static void main(String[] args) {
		Dept dept = new Dept(1, 10, "abc");
		Dept dept1 = new Dept(2, 20, "xyz");
		List<EmployeeRepository> empList = new ArrayList<EmployeeRepository>();
		empList = Arrays.asList(
				new EmployeeRepository(100, 1, "Abhishek", "raju", "abc@gmail.com", "9866912280", "Executive",
						LocalDate.of(2021, 4, 17), 25000d, dept),
				new EmployeeRepository(201, 2, "Ravichandra", "Kumar", "ravichandrakumar1@gmail.com", "9096684836", "Analyst",
						LocalDate.of(2021, 4, 11), 30000d, dept1),
				new EmployeeRepository(103, 1, "Siva", "ram", "Sivaram@gmail.com", "8983349675", "Analyst",
		...
		Map<Dept, Long> de = empList.stream()
